...
namespace Demo3Subscribe
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<ISubscribe, Subscribe>();
            services.AddCap(options =>
            {
                options.UseEntityFramework<SubscribeDbContext>(efOptions =>
                {
                ...
                options.UseRabbitMQ(mqOptions =>
                {
                    ...
                    mqOptions.ExchangeName = "cap.defaultsubscribe.topic"; //CAP默认Exchange名称 默认：cap.default.topic
