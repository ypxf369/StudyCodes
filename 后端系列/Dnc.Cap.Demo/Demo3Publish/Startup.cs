...
namespace Demo3Publish
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<PublishDbConext>();
            services.AddCap(options =>
            {
                options.UseEntityFramework<PublishDbConext>(efOptions =>
                {
                ...
                options.UseRabbitMQ(mqOptions =>
                {
                    ...
                    mqOptions.ExchangeName = "cap.defaultpublish.topic"; //CAP默认Exchange名称 默认：cap.default.topic
