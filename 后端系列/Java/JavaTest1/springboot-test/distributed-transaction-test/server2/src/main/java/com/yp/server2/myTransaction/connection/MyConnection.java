package com.yp.server2.myTransaction.connection;
...
public class MyConnection implements Connection {
    ...
    public MyConnection(Connection connection, MyTransaction myTransaction) {
    ...
    public void commit() throws SQLException {
        new Thread(() -> {
            try {
                ...
                if (myTransaction.getType().equals(TransactionType.COMMIT)) {
                    connection.commit();
                } else {
                    connection.rollback();
                }
