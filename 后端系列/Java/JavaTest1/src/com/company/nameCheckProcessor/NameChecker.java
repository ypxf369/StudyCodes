...
public class NameChecker {
    ...
    /**
     * 对Java程序命名进行检查，Java程序命名应当符合下列格式：
     * <ul>
     * <li>类或接口：符合驼峰式命名法，首字母大写</li>
    ...
    /**
     * 名称检查器实现类，集成了 JDK 1.8 中提供的ElementScanner8<br>
    ...
    private class NameCheckScanner extends ElementScanner8<Void, Void> {
        ...
        private boolean heuristicallyConstant(VariableElement element) {
            if (element.getEnclosingElement().getKind() == ElementKind.INTERFACE) {
                return true;
            } else if (element.getKind() == ElementKind.FIELD && element.getModifiers().containsAll(EnumSet.of(Modifier.PUBLIC, Modifier.STATIC, Modifier.FINAL))) {
                return true;
            } else {
                return false;
            }
        ...
        /**
         * 检查掺入的Element是否符合驼峰命名法，如果不符合，则输出警告信息
         */
